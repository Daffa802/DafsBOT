...
/////////////////
const BotName = 'DAFS BOT☄'; 
const instagram = 'https://instagram.com/Dafs_114.id'; 
const telegram = 'https://t.me/reuzzz'; 
const kapanbotaktif = 'KETIKA OWNER ONLINE'; 
...
conn.on('message-status-update', json =>
{
   ...
   console.log(`[ ${moment().format("HH:mm:ss")} ] => bot by ig:@Dafs_114.id`)
})
...
axios.get(`https://mhankbarbar.herokuapp.com/nulis?text=${teks}&apiKey=zFuV88pxcIiCWuYlwg57`).then((res) => {
    let hasil = `Silahkan download hasil dibawah ini agar hasilnya lebih bagus! 👌\n\n${res.data.result}`;/n/nUkuran tulisan: ${res.data.filesize}/n/nLink: ${res.data.result}`:
